...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 08, 2019 at 12:52 PM
...
INSERT INTO `travels` (`id`, `member_id`, `types_id`, `from`, `where`, `date`, `created_at`, `updated_at`) VALUES
...
(6, 'Hamza Zeb', 'admin@hamzazeb.com', NULL, '$2y$10$pJ9EqYghQA7jPVcsN2Zx8OzIlOuMK572S5m1aFRGcHopHME5mjbW6', 'c5zfIb5Artk1kHeINXpqVJuHzs2y2ewSxX1oZ7o7mOPo5K64BIyhZThAEsJU', '2019-07-03 23:51:05', '2019-07-03 23:51:05');
...
--
ALTER TABLE `slips`
  ADD CONSTRAINT `slips_travel_id_foreign` FOREIGN KEY (`travel_id`) REFERENCES `travels` (`id`) ON DELETE CASCADE;
